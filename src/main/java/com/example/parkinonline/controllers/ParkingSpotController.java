package com.example.parkinonline.controllers;

import com.example.parkinonline.AppProperties;
import com.example.parkinonline.MyBean;
...
//@Controller (Quando for utilizado todas as camadas de projeto MVC, pois utiliza-se views neste padrão)
@RestController
